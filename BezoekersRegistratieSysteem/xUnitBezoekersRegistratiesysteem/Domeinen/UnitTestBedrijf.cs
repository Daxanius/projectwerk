...
namespace xUnitBezoekersRegistratiesysteem.Domein
{
    public class UnitTestBedrijf
    {
        ...
        {
            Bedrijf b = new(10, "bedrijf", "BE123456789", "012345678", "bedrijf@email.com", "bedrijfstraat 10");
            b.ZetNaam(naamIn);
        ...
        #region UnitTest BTW
        [Theory]
        [InlineData("BE123456789", "BE123456789")]
        [InlineData("     BE123456789", "BE123456789")]
        [InlineData("BE123456789     ", "BE123456789")]
        ...
        [InlineData("\t")]
        [InlineData("\v")]
        public void ZetBTW_Invalid(string naam)
        {
            Bedrijf _b = new(10, "bedrijf", "BE123456789", "012345678", "bedrijf@email.com", "bedrijfstraat 10");
            Assert.Throws<BedrijfException>(() => _b.ZetBTW(naam));
        }
        #endregion
        ...
        [Theory]
        [InlineData(0, "bedrijf", "BE123456789", "012345678", "bedrijf@email.com", "bedrijfstraat 10")]
        [InlineData(10, "fjirdeb", "BE123456789", "012345678", "bedrijf@email.com", "bedrijfstraat 10")]
        [InlineData(10, "bedrijf", "BE987654321", "012345678", "bedrijf@email.com", "bedrijfstraat 10")]
        [InlineData(10, "bedrijf", "BE123456789", "876543210", "bedrijf@email.com", "bedrijfstraat 10")]
        [InlineData(10, "bedrijf", "BE123456789", "012345678", "anderbedrijf@email.com", "bedrijfstraat 10")]
        [InlineData(10, "bedrijf", "BE123456789", "012345678", "bedrijf@email.com", "anderebedrijfstraat 10")]
        public void BedrijfIsGelijk_Invalid(uint id, string naam, string btwNummer, string telefoonNummer, string email, string adres)
        {
            Bedrijf b1 = new(10, "bedrijf", "BE123456789", "012345678", "bedrijf@email.com", "bedrijfstraat 10");
        ...
        [Theory]
        [InlineData(10, "bedrijf", "BE123456789", "012345678", "bedrijf@email.com", "bedrijfstraat 10", 10, "bedrijf", "BE123456789", "012345678", "bedrijf@email.com", "bedrijfstraat 10")]
        ...
        [Theory]
        [InlineData(10, null, "BE123456789", "012345678", "bedrijf@email.com", "bedrijfstraat 10")]
        [InlineData(10, "", "BE123456789", "012345678", "bedrijf@email.com", "bedrijfstraat 10")]
        [InlineData(10, " ", "BE123456789", "012345678", "bedrijf@email.com", "bedrijfstraat 10")]
        [InlineData(10, "\n", "BE123456789", "012345678", "bedrijf@email.com", "bedrijfstraat 10")]
        [InlineData(10, "\r", "BE123456789", "012345678", "bedrijf@email.com", "bedrijfstraat 10")]
        [InlineData(10, "\t", "BE123456789", "012345678", "bedrijf@email.com", "bedrijfstraat 10")]
        [InlineData(10, "\v", "BE123456789", "012345678", "bedrijf@email.com", "bedrijfstraat 10")]
        ...
        [InlineData(10, "bedrijf", "BE123456789", null, "bedrijf@email.com", "bedrijfstraat 10")]
        [InlineData(10, "bedrijf", "BE123456789", "", "bedrijf@email.com", "bedrijfstraat 10")]
        [InlineData(10, "bedrijf", "BE123456789", " ", "bedrijf@email.com", "bedrijfstraat 10")]
        [InlineData(10, "bedrijf", "BE123456789", "\n", "bedrijf@email.com", "bedrijfstraat 10")]
        [InlineData(10, "bedrijf", "BE123456789", "\r", "bedrijf@email.com", "bedrijfstraat 10")]
        [InlineData(10, "bedrijf", "BE123456789", "\t", "bedrijf@email.com", "bedrijfstraat 10")]
        [InlineData(10, "bedrijf", "BE123456789", "\v", "bedrijf@email.com", "bedrijfstraat 10")]
        [InlineData(10, "bedrijf", "BE123456789", "0123456789101112", "bedrijf@email.com", "bedrijfstraat 10")]

        [InlineData(10, "bedrijf", "BE123456789", "012345678", null, "bedrijfstraat 10")]
        [InlineData(10, "bedrijf", "BE123456789", "012345678", "", "bedrijfstraat 10")]
        [InlineData(10, "bedrijf", "BE123456789", "012345678", " ", "bedrijfstraat 10")]
        [InlineData(10, "bedrijf", "BE123456789", "012345678", "\n", "bedrijfstraat 10")]
        [InlineData(10, "bedrijf", "BE123456789", "012345678", "\r", "bedrijfstraat 10")]
        [InlineData(10, "bedrijf", "BE123456789", "012345678", "\t", "bedrijfstraat 10")]
        [InlineData(10, "bedrijf", "BE123456789", "012345678", "\v", "bedrijfstraat 10")]
        [InlineData(10, "bedrijf", "BE123456789", "012345678", "@email.com", "bedrijfstraat 10")]
        [InlineData(10, "bedrijf", "BE123456789", "012345678", "bedrijf@email.", "bedrijfstraat 10")]
        [InlineData(10, "bedrijf", "BE123456789", "012345678", "bedrijf@.com", "bedrijfstraat 10")]
        [InlineData(10, "bedrijf", "BE123456789", "012345678", "bedrijf@email", "bedrijfstraat 10")]
        [InlineData(10, "bedrijf", "BE123456789", "012345678", "bedrijf@", "bedrijfstraat 10")]
        [InlineData(10, "bedrijf", "BE123456789", "012345678", "bedrijf", "bedrijfstraat 10")]
        [InlineData(10, "bedrijf", "BE123456789", "012345678", "bedrijf@.", "bedrijfstraat 10")]
        [InlineData(10, "bedrijf", "BE123456789", "012345678", "bedrijf.com", "bedrijfstraat 10")]

        [InlineData(10, "bedrijf", "BE123456789", "012345678", "bedrijf@email.com", null)]
        [InlineData(10, "bedrijf", "BE123456789", "012345678", "bedrijf@email.com", "")]
        [InlineData(10, "bedrijf", "BE123456789", "012345678", "bedrijf@email.com", " ")]
        [InlineData(10, "bedrijf", "BE123456789", "012345678", "bedrijf@email.com", "\n")]
        [InlineData(10, "bedrijf", "BE123456789", "012345678", "bedrijf@email.com", "\r")]
        [InlineData(10, "bedrijf", "BE123456789", "012345678", "bedrijf@email.com", "\t")]
        [InlineData(10, "bedrijf", "BE123456789", "012345678", "bedrijf@email.com", "\v")]
