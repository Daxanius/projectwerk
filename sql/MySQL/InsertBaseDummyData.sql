 ...
 */
INSERT INTO Groupswork.Functie (FunctieNaam)
VALUES('Ceo'),
	('Cfo'),
	('Sanitair Medewerker'),
...
INSERT INTO Groupswork.AfspraakStatus (AfspraakStatusNaam)
VALUES('Lopend'),
	('Verwijderd'),
	('Stopgezet door gebruiker'),
	('Stopgezet door systeem'),
	('Stopgezet door admin');
INSERT INTO Groupswork.Bezoeker (Vnaam, ANaam, Email, EigenBedrijf)
VALUES(
		'Bart',
		'Smis',
		'BartSmis@Outlook.com',
		'Smisses NV'
	),
	(
		'Niet',
		'Geert',
		'NietGeert@Outlook.com',
		'NietGeert NV'
	),
	(
		'David',
		'Brex',
		'Davidbrex@Outlook.com',
		'Dominos'
	);
INSERT INTO Groupswork.Werknemer (VNaam, ANaam)
VALUES('Ruby', 'Tucker'),
	('Sharon', 'Cunningham'),
	('Mary', 'Walsh'),
	('Blanca', 'Buchanan'),
	...
	('Benjamin', 'Oliver'),
	('Jeanette', 'Reynolds');
INSERT INTO Groupswork.Bedrijf (Naam, BTWNr, TeleNr, Email, Adres, BTWChecked)
VALUES(
		'allphi',
		'BE0838576480',
		'093961130',
	...
	(
		...
		'092729911',
		'info@orbid.be',
		'guldensporenpark 29 9820 merelbeke',
		1
	),
	(
		'cerence',
	...
	(
		...
		'0489243921',
		'bistro@insieme.eu',
		'guldensporenpark 31 9820 merelbeke',
		1
	),
	(
		'thermo fisher',
		...
		'guldensporenpark 26 9820 merelbeke',
		1
	),
	(
		'cadmes',
		...
		'092222323',
		'info@cadmes.com',
		'guldensporenpark 12 9820 merelbeke',
		1
	),
	(
		'hybrid software',
	...
	(
		...
		'BE0423956118',
		'0483631624',
		'advertisersupport@doubleverify.com',
		'guldensporenpark 2 9820 merelbeke',
		1
	),
	(
		'infor',
		'BE0456494767',
		'092361636',
		'middle.east@infor.com',
		'guldensporenpark 78 9820 merelbeke',
		1
	),
	(
		'eastman',
		...
		'18003278626',
		'taminco@eastman.be',
		'guldensporenpark 74 9820 merelbeke',
		1
	),
	(
		'santander',
	...
	(
		...
		'038719966',
		'info@appfoundry.be',
		'guldensporenpark 88 9820 merelbeke',
		1
	),
	(
		'axxes',
		...
		'033034404',
		'info@axxessid.com',
		'guldensporenlaan 2 9820 merelbeke',
		1
	),
	(
		'linak',
	...
	(
		...
		'BE0874633459',
		'092105740',
		'gent@walterspeople.com',
		'guldensporenpark 25 9820 merelbeke',
		1
	);
INSERT INTO Groupswork.Werknemerbedrijf(
		BedrijfId,
		WerknemerId,
		FunctieId,
		WerknemerEmail
...
INSERT INTO Groupswork.Afspraak (StartTijd, WerknemerBedrijfId, BezoekerId)
VALUES(NOW(), 1, 1),
	(NOW(), 30, 2),
	(NOW(), 3, 3);
...
DELIMITER $$ CREATE procedure Groupswork.GenerateParkeerPlaatsen() BEGIN
DECLARE i INT;
...
SET i = 0;
label: WHILE (i < AantalBedrijven) DO
