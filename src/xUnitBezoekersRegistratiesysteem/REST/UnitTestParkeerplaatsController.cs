...
namespace xUnitBezoekersRegistratieSysteem.REST {
	public class UnitTestParkeerplaatsController {
		#region MOQ
		// Moq repos
		private Mock<IParkingContractRepository> _mockRepoParkingContract;
		private Mock<IParkeerplaatsRepository> _mockRepoParkeerplaats;
		...
		// Controllers
		private ParkeerplaatsController _parkeerplaatsController;
		#endregion
		...
		public UnitTestParkeerplaatsController() {
			// Moq repos
			...
			// Controllers
			_parkeerplaatsController = new(_parkingContractManager, _parkeerPlaatsManager, _bedrijfManager);
