...
namespace BezoekersRegistratieSysteemBL.Managers {
	public class UnitTestAfspraakManager {
		...
		[Fact]
		public void GeefHuidigeAfspraakBezoekerPerBedrijf_Invalid_BezoekerId() {
			_mockRepo = new Mock<IAfspraakRepository>();
			_afspraakManager = new AfspraakManager(_mockRepo.Object);

			//"AfspraakManager - GeefHuidigeAfspraakBezoekerPerBedrijf - bezoeker id moet groter dan 0 zijn"
			Assert.Throws<AfspraakManagerException>(() => _afspraakManager.GeefHuidigeAfspraakBezoekerPerBedrijf(-1, _bd));
		}
		...
		public void GeefHuidigeAfspraakBezoekerPerBedrijf_Invalid_BedrijfLeeg() {
			...
			Assert.Throws<AfspraakManagerException>(() => _afspraakManager.GeefHuidigeAfspraakBezoekerPerBedrijf(_b.Id, null));
		}
		...
		public void GeefHuidigeAfspraakBezoekerPerBedrijf_Invalid_GeenAfspraken() {
			...
			var ex = _afspraakManager.GeefHuidigeAfspraakBezoekerPerBedrijf(_b.Id, _bd);
